...
<div class="container">
    <div style="text-align: center;">
       ...
       <button type="button" class="btn btn-warning btn-lg-3" onclick="location.href='EventServlet?command=contest_recipewrite&eventno=${gang.eventno}'">참여하기</button>
	...
	<div class="album py-5 bg-light">
		<div class="container">
			<a href="EventServlet?command=contest_moreview&eventno${gang.eventno}">
