	...
	<div class="container mt-5">
		<div class="input-form-backgroud row mx-auto" style="width: 300px;">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" action="MemberServlet" method="post" novalidate>
				<input type="hidden" name="command" value="member_join">
					...
					<div class="col-12 mb-3">
							...
							<c:set var="id" value="${param.id}"></c:set>
								<c:choose>
									<c:when test="${not empty id}">
										<input type="text" class="form-control" id="id" name="userid" placeholder="" value="${id}" disabled="disabled">
									</c:when>
									<c:otherwise>
						...
						<div class="col-12 mb-3">
							...
							<input type="password" class="form-control" id="passwordconfirm" name = "pwdconfirm" placeholder="" value="" required>
					...
					<div class="custom-control custom-checkbox text-center">
						...
						<button class="btn btn-lg btn-block mt-3" style="background-color: #fac279;" type="button" onclick="InsertFrm()">가입 완료</button>
					</div>
					<div class="mb-5"></div>
				</form>
			</div>
