		...
		<div class="container">
			...
			<table class="table table-hover" style="height: 300px;">
				...
				<tbody class="table-secondary">
					<c:forEach var="dietDetail3" items="${dietDetailList3}">
					<tr>
						<td class="h5 border-end">${dietDetail3.foodName}</td>
						<td class="h5 border-end">${dietDetail3.kcal}</td>
						<td class="h5">${dietDetail3.component}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
