		...
		<div class="container">
			...
			<table class="table table-hover" style="height: 300px;">
				...
				<tbody class="table-secondary">
					<c:forEach var="dietDetail4" items="${dietDetailList4}">
					<tr>
						<td class="h5 border-end">${dietDetail4.foodName}</td>
						<td class="h5 border-end">${dietDetail4.kcal}</td>
						<td class="h5">${dietDetail4.component}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
