...
<div class="container border mt-3 rounded-3 w-50">
  <ul class="nav nav-pills nav-fill row">
    ...
    <li class="nav-item col-12 col-md-3">
      <a class="nav-link active" style=" color: black;" aria-current="page" href="lowdiet.jsp">저칼로리식단</a>
  </li>
  <li class="nav-item col-12 col-md-3">
          ...
          <div class="row" >
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='lowdiet.jsp'">아침</button>
                </div>
                <img src="../resources/img/lowkcal.png" class="img-fluid3">
                <div class="mealment">전체 칼로리가 450kcal인 레시피로 이루어진 식단</div>
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='lowdiet_lunch.jsp'">점심</button>
                </div>
                <img src="../resources/img/lowkcal.png" class="img-fluid3">
                <div class="mealment">전체 칼로리가 450kcal인 레시피로 이루어진 식단</div>
              </div>
            ...
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='lowdiet_dinner.jsp'">저녁</button>
                </div>
                <img src="../resources/img/lowkcal.png" class="img-fluid3">
                <div class="mealment"> 전체 칼로리가 450kcal인 레시피로 이루어진 식단</div>
              </div>
