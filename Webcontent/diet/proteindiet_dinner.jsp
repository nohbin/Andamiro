...
<div class="container border mt-3 rounded-3 w-50">
  ...
  <li class="nav-item col-12 col-md-3">
    <a class="nav-link active" style=" color: black;" aria-current="page" href="proteindiet.jsp">프로틴식단</a>
</li>
  </ul>  
</div>
          ...
          <div class="row" >
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='proteindiet.jsp'">아침</button>
                </div>
                <img src="../resources/img/protein_img.png" class="img-fluid3">
                <div class="mealment">단백질 함량이 높은 레시피로 이루어진 식단</div>
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='proteindiet_lunch.jsp'">점심</button>
                </div>
                <img src="../resources/img/protein_img.png" class="img-fluid3">
                <div class="mealment">단백질 함량이 높은 레시피로 이루어진 식단</div>
              </div>
            ...
            <div class="col-12 col-md-4">
              <div class="text-center">
                <div>
                  <button type="button" class="btn btn-outline-warning mb-3" onclick="location.href='proteindiet_dinner.jsp'">저녁</button>
                </div>
                <img src="../resources/img/protein_img.png" class="img-fluid3">
                <div class="mealment"> 단백질 함량이 높은 레시피로 이루어진 식단</div>
              </div>
