		...
		<div class="container">
			...
			<table class="table table-hover" style="height: 300px;">
				...
				<tbody class="table-secondary">
					<c:forEach var="dietDetail2" items="${dietDetailList2}">
					<tr>
						<td class="h5 border-end">${dietDetail2.foodName}</td>
						<td class="h5 border-end">${dietDetail2.kcal}</td>
						<td class="h5">${dietDetail2.component}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
