...
public class rec_lunchAction implements SubDietAction {

	@Override
	public void excute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/diet/recdiet_lunch.jsp";
		...
		//식단상세정보 출력
		List<dietDetailVO> dietdetailList2 = dietDetailDao.selectDietDetail2();
 		request.setAttribute("dietDetailList2", dietdetailList2);
