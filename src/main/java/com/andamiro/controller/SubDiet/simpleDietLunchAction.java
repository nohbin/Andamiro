...
public class simpleDietLunchAction implements SubDietAction {

	@Override
	public void excute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/diet/simplediet_lunch.jsp";
		...
		//식단상세정보 출력
		List<dietDetailVO> dietdetailList = dietDetailDao.selectSimpleDetail();
