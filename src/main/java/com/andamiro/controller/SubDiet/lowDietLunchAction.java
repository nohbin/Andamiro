...
public class lowDietLunchAction implements SubDietAction {

	@Override
	public void excute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/diet/lowdiet_lunch.jsp";
		...
		//식단상세정보 출력
		List<dietDetailVO> dietdetailList5 = dietDetailDao.selectDietDetail5();
 		request.setAttribute("dietDetailList5", dietdetailList5);
