...
public class lowDietAction implements SubDietAction {

	@Override
	public void excute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/diet/lowdiet.jsp";
		...
		//식단상세정보 출력
		List<dietDetailVO> dietdetailList4 = dietDetailDao.selectDietDetail4();
 		request.setAttribute("dietDetailList4", dietdetailList4);
