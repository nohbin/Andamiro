...
public class proteinDinnerAction implements SubDietAction {

	@Override
	public void excute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		String url = "/diet/proteindiet_dinner.jsp";
		...
		//식단상세정보 출력
		List<dietDetailVO> dietdetailList = dietDetailDao.selectProteinDinnerDetail();
