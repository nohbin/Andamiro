	...
	<main class="form-signin w-100 m-auto text-center">
		...
		<input type="hidden" name="command" value="member_login">
			...
			<div class="form-floating mb-2 rounded-5">
				<input type="text" class="form-control rounded-3" id="floatingInput" name="userid" placeholder="userid"> 
			...
			${message }
			<button class="w-100 btn btn-lg" type="submit" onclick="return loginCheck()"
				style="background-color: #fac279;">로그인
			</button>
